...
django-twoscoops-project, run the following command::
    ...
    $ django-admin.py startproject --template=https://github.com/patrickbeeson/django-twoscoops-project/archive/master.zip --extension=py,rst,html icecream_project
